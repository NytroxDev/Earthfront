import pygame
import pygame_gui
from core.path_manager import Images, check_path
from core.game.camera import Camera
from core.game.ui import GameUI
from core.game.menu import MainMenu
from core.data_handler import DataManager
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Carte Explorer - v1.0")
